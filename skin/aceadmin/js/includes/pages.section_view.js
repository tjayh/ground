...
CMS.initPage = function()
{
	$('a.setFormValues').on('click', function()
	{
		...
		$("#" + cont_type + "_type #template_name_" + data.template_name).prop("checked", true);
	...
	{ /* event if top edit button is clicked */ });
	$('#submit').on('click', function()
	{ /* event if submit button is clicked */ });
...
$(".val-page").click(function()
{
	...
	{ //event if a template name is selected
	...
	{ //event if a template name is not selected
