...
function changeStatus() {
    ...
    var keyAndVal = "data%5Bwhr_id_faq_category%5D=" + itemID + "&data%5Bclmn_active%5D=" + enableModule;
    $.post(thisURL + thisModule + "/process/change-cat_status", keyAndVal, function(data) {
        setTimeout(function() {
        ...
        setTimeout(function() {
            if (data != 'false') {
                ...
                if (dataJ.error != null) CMS.showNotification('error', dataJ.error);
                    ...
                    if (enableModule == 1) {
                        CMS.showNotification('success', 'FAQ Category is successfully Enabled');
                        ...
                        CMS.showNotification('success', 'FAQ Category is successfully Disabled');
