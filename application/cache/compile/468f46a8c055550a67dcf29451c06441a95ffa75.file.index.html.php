<?php /* Smarty version Smarty-3.0.6, created on 2015-10-14 10:42:02
         compiled from "C:\xampp\htdocs\samplewebsite30\skin/aceadmin/modules/blog_manager/index.html" */ ?>
<?php /*%%SmartyHeaderCode:16725561e155a1aba32-01681339%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '468f46a8c055550a67dcf29451c06441a95ffa75' => 
    array (
      0 => 'C:\\xampp\\htdocs\\samplewebsite30\\skin/aceadmin/modules/blog_manager/index.html',
      1 => 1441094769,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16725561e155a1aba32-01681339',
  'function' => 
  array (
  ),
								...
								<div class="col-xs-12">
									<div>
										<div class="step-pane" id="step1">
											<input type="hidden" id="id_blog_item_where" name="where[id_blog_item]" value="" /> 
											<div class="form-group hid">
												<label class="col-sm-2 control-label no-padding-right" for="id_blog_category"> Category </label>
												<div class="col-sm-10">
													<select id="id_blog_category" name="data[id_blog_category]" class="fieldEditable">
...
?>
																	<option value="<?php echo $_smarty_tpl->tpl_vars['sub']->value['id_blog_category'];?>
...
/process/upload-image" /> </div>
		...
		<div class="col-xs-12">
			<div class="table-header">
				<button id="dtAddRow" class="btn btn-sm pull-right btn-info showWidge addReset"> <i class="icon-plus"></i> Add Blog </button>
				...
				<div class="dataTables_borderWrap">
					<div>
						<table id="DT_Generic" style="display:none;" class="table table-striped table-bordered table-hover dataTable">
							...
							<tbody> <?php if ($_smarty_tpl->getVariable('blog')->value){?> 
							<?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable;
...
" style="max-height: 100px; max-width: 100px;"><?php }?></td>
									...
									<td class="center"> 
										<?php if ($_smarty_tpl->tpl_vars['item']->value['status']=='0'){?>
											<a class="showGlobal ignore" id="stat<?php echo $_smarty_tpl->tpl_vars['item']->value['id_blog_item'];?>
" style="color:#d15b47 !Important;" data-getDetails="enableFxn" data-modID="jdata<?php echo $_smarty_tpl->tpl_vars['item']->value['id_blog_item'];?>
" title="Enable item status"> <span class="label label-danger">InActive</span> </a> 
											<?php }else{ ?>
											<a class="showGlobal ignore" id="stat<?php echo $_smarty_tpl->tpl_vars['item']->value['id_blog_item'];?>
" style="color:#87b87f !Important;" data-getDetails="disableFxn" data-modID="jdata<?php echo $_smarty_tpl->tpl_vars['item']->value['id_blog_item'];?>
" title="Diable item status"> <span class="label label-success"> Active </span> </a> 
										<?php }?> 
									</td>
									<td class="td-actions" id="jdata<?php echo $_smarty_tpl->tpl_vars['item']->value['id_blog_item'];?>
" data-var="modules">
										<div class="hid" id="jd<?php echo $_smarty_tpl->tpl_vars['item']->value['id_blog_item'];?>
										...
										<div class="center">
											<div class="inline position-relative">
												...
												<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
													...
													<li>
														<a href="javascript:;" class="tooltip-error showGlobal ignore tooltip-error" data-rel="tooltip" title="Delete" title="Delete" data-modID="jdata<?php echo $_smarty_tpl->tpl_vars['item']->value['id_blog_item'];?>
