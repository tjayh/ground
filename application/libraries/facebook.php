...
class Facebook {
		...
		function Facebook()
		{
			...
			$this->_api_url 	= $this->CI->config->item('facebook_api_url');
			$this->_api_key 	= $this->CI->config->item('facebook_app_id');
			$this->_api_secret 	= $this->CI->config->item('facebook_api_secret');
	...
	class facebookSession {
		...
		function __construct()
		{
			...
			$this->_token_url 	= $this->CI->config->item('facebook_api_url').$this->_token_url;
			$this->_user_url 	= $this->CI->config->item('facebook_api_url').$this->_user_url;
			
			$this->_set('scope', $this->CI->config->item('facebook_default_scope'));
